...
from model.preprocess.dataset import CityData
...
if __name__ == '__main__':
    args = parse_args()
    city_data = CityData(args.city, random_radius=0.01, with_random=not args.no_random)
    ...
    # embeddings = np.load(f'./data/embeddings/{args.city}/{args.save_name}_20.npy')
