...
class Preprocess(object):
    def __init__(self):
        ...
        self.building_in_path = in_path + 'buildings/building.shp'
        self.poi_in_path = in_path + 'pois/pois.shp'
        ...
        self.poi_out_path = out_path + 'pois.pkl'
        
        self.boundary_in_path = in_path + 'boundary/boundary.shp'
    ...
    def rasterize_buildings(self, building_list, rotation=True, force=False):
        ...
        images = np.zeros((len(building_list), 32, 32), dtype=np.uint8) ## 224x224
        ...
        for i in trange(len(building_list)):
            ...
            transform = rasterio.transform.from_bounds(min_x, min_y, max_x, max_y, 32, 32)
            image = rasterio.features.rasterize([polygon], out_shape=(32, 32), transform=transform)
            images[i] = image
